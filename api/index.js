...
<body class="bg-[#F4F6F9] text-[#2C3E50] font-sans">
    ...
    <nav class="bg-[#1B365D] text-white shadow-md">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <a href="/dashboard" class="bg-[#00875A] hover:bg-emerald-700 px-4 py-2 rounded-lg text-sm font-semibold transition">Student Dashboard</a>
        </div>
    </nav>
    ...
    <header class="max-w-7xl mx-auto px-6 py-16 text-center">
        ...
        <div class="flex justify-center gap-4">
            <a href="/calculator" class="bg-[#00875A] text-white px-6 py-3 rounded-lg font-semibold shadow hover:bg-emerald-700 transition">Calculate Repayment</a>
            <a href="/dashboard" class="bg-[#1B365D] text-white px-6 py-3 rounded-lg font-semibold shadow hover:bg-blue-900 transition">Get Started</a>
        </div>
    </header>
